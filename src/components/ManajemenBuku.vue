  ...
  <div class="container mt-3">
      ...
      <div id="formTambah" v-if="formMode == 'create'">
          ...
          <form class="form row" @submit.prevent="submitAdd">
              ...
              <div class="col-2">
                  <input type="number" class="form-control mx-2" placeholder="Harga" v-model="newBook.harga"/>
              </div>
              <div class="col-2">
      ...
      <div id="formUbah" v-if="formMode == 'edit'">
          ...
          <form class="form row" @submit.prevent="submitChange">
              ...
              <div class="col-2">
                  <input type="number" class="form-control mx-2" placeholder="Harga" v-model="updatedBook.harga"/>
              </div>
              <div class="col-2">
      ...
      <table class="table table-bordered">
          ...
          <tbody>
              <tr v-for="(book, index) in bookList" :key="index">
                  ...
                  <td>{{ book.stok }}</td>
                  <td>
                      <button class="btn btn-info me-3" @click="showEdit(book, index)">Edit</button>
